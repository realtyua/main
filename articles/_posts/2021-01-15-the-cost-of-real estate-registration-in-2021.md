...
Відповідно до Закону України "[https://zakon.rada.gov.ua/laws/show/1082-20#Text _blank](Про Державний бюджет України на  2021 рік)" прожитковий мінімум для працездатних осіб на 01 січня 2021 року становить  2270 гривень.

Стаття 34 Закону України "[https://zakon.rada.gov.ua/laws/show/1952-15#Text _blank](Про державну реєстрацію речових прав на нерухоме майно та їх обтяжень)" встановлює адміністративний збір у таких розмірах:

<div class="table-responsive">
<table class="table table-sm table-hover table-striped">
  <caption>Про державну реєстрацію речових прав на нерухоме майно та їх обтяжень встановлює адміністративний збір у таких розмірах: Таблиця</caption>
  <thead>
    <tr>
      <td>
