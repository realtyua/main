...
$(".btn-group .dropdown-toggle").on("click", function(event){
    var liparent=$(this.parentElement);
    var divChild=liparent.find('div');
    var xOffset=liparent.offset().left;
    var alignRight=($(document).width()-xOffset)<xOffset;
    if (liparent.hasClass("dropdown-menu")) {
    } else {
      divChild.toggleClass("dropdown-menu-right", alignRight);
    }
});
