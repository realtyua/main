...
"use strict"; var cd = new Date(); var cn = cd.getMonth(); var d = new Date(row.date); var n = d.getMonth();
var reСoordinates = function() { html = ['<span class="row row-cols-1 row-cols-sm-2 row-cols-md-3 mx-n1">', ]
